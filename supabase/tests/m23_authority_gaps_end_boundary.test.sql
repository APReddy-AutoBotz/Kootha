...
insert into public.ad_work_assignments(id,ad_work_id,driver_id,vehicle_id,status)
values('2a000000-0000-0000-0000-000000000051','2a000000-0000-0000-0000-000000000050','2a000000-0000-0000-0000-000000000001','2a000000-0000-0000-0000-000000000002','ready_for_execution');
insert into public.ad_work_days(id,ad_work_id,work_date,driver_id,vehicle_id,execution_status,execution_started_at)
...
values
  ...
  ('2a000000-0000-0000-0000-000000000054','2a000000-0000-0000-0000-000000000051','2a000000-0000-0000-0000-000000000050','2a000000-0000-0000-0000-000000000006','2a000000-0000-0000-0000-000000000007','assigned','2026-07-31 09:30+00','2026-07-31 11:00+00','observed');
insert into public.m21_release_history(id,ad_work_id,release_status,effective_from,effective_until,history_origin)
values
...
insert into public.ad_work_assignments(id,ad_work_id,driver_id,vehicle_id,status)
values('2a000000-0000-0000-0000-000000000071','2a000000-0000-0000-0000-000000000070','2a000000-0000-0000-0000-000000000001','2a000000-0000-0000-0000-000000000002','ready_for_execution');
insert into public.ad_work_days(id,ad_work_id,work_date,driver_id,vehicle_id,execution_status,execution_started_at)
...
values
  ...
  ('2a000000-0000-0000-0000-000000000075','2a000000-0000-0000-0000-000000000071','2a000000-0000-0000-0000-000000000070','2a000000-0000-0000-0000-000000000001','2a000000-0000-0000-0000-000000000002','assigned','2026-07-31 09:30+00','2026-07-31 11:00+00','observed');
insert into public.m21_release_history(id,ad_work_id,release_status,effective_from,effective_until,history_origin)
