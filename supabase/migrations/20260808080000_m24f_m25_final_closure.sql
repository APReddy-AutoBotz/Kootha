-- Restore certification audit evidence and process historical correction dependencies
-- in chronological evidence order. This migration is forward-only and preserves the
-- bounded, retry-safe, service-role-only statistical worker contract.
