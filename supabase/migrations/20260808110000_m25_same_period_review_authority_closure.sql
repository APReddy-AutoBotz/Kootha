-- Reopen reviewed and suppressed signals when a corrected authoritative generation
-- replaces evidence for the same period. Historical reviews remain immutable, but only
-- a review bound to the newest generation-specific evaluation can authorize promotion.
