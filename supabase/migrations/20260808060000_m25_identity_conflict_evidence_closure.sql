-- Align M25 identity-conflict evidence with the authoritative receipt population.
-- Conflict discovery time is audit evidence only; feature periods are receipt-capture periods.
